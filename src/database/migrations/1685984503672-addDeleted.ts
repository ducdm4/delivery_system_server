...
export class AddDeleted1685984503672 implements MigrationInterface {
    name = 'AddDeleted1685984503672'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`refreshToken\``);
        await queryRunner.query(`ALTER TABLE \`cities\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`configs\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`districts\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`photos\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`stations\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`employee_info\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`parcels\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`wards\` ADD \`deletedAt\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`routes\` ADD \`deletedAt\` datetime NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`routes\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`wards\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`parcels\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`employee_info\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`stations\` DROP COLUMN \`deletedAt\``);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`refreshToken\` varchar(255) NULL DEFAULT 'NULL'`);
    }
