...
export class UpdateOt1701101964927 implements MigrationInterface {
    name = 'UpdateOt1701101964927'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`previousStationInChargeId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`previousStationInChargeId\``);
    }
