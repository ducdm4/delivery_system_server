...
export class UpdateNotification1703094062269 implements MigrationInterface {
    name = 'UpdateNotification1703094062269'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`notificationToken\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`notificationToken\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`notificationToken\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`notificationToken\``);
    }
