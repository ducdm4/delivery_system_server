...
export class AddUpdated1685985648509 implements MigrationInterface {
    name = 'AddUpdated1685985648509'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`photos\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`districts\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`wards\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`photos\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`updatedAt\` \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`employee_info\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`employee_info\` CHANGE \`updatedAt\` \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`cities\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`districts\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`wards\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`routes\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`updatedAt\` \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`parcels\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`parcels\` CHANGE \`updatedAt\` \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_tracking\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` CHANGE \`updatedAt\` \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`configs\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`configs\` CHANGE \`updatedAt\` \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`configs\` CHANGE \`updatedAt\` \`updatedAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`configs\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_tracking\` CHANGE \`updatedAt\` \`updatedAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`parcels\` CHANGE \`updatedAt\` \`updatedAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`parcels\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`parcels\` ADD CONSTRAINT \`FK_7ff331a7e5c6057dccd871face0\` FOREIGN KEY (\`photoId\`) REFERENCES \`photos\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`parcels\` ADD CONSTRAINT \`FK_6ba773e1ec316866a17d46885a4\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`routes\` CHANGE \`updatedAt\` \`updatedAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`routes\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`wards\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`wards\` ADD CONSTRAINT \`FK_812309cfc78b10b505a6cd44df5\` FOREIGN KEY (\`districtId\`) REFERENCES \`districts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`districts\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`districts\` ADD CONSTRAINT \`FK_65f489c5687887adeeb14b87df7\` FOREIGN KEY (\`cityId\`) REFERENCES \`cities\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cities\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`cities\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`employee_info\` CHANGE \`updatedAt\` \`updatedAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`employee_info\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`employee_info\` ADD CONSTRAINT \`FK_3b4bef102967f512afe9f968db3\` FOREIGN KEY (\`stationId\`) REFERENCES \`stations\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`employee_info\` ADD CONSTRAINT \`FK_c4ac770e19c7fbfc8a029dbd2c6\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`employee_info\` ADD CONSTRAINT \`FK_fb2ae22bdee99c7250d7e4cdafd\` FOREIGN KEY (\`identityCardImage2Id\`) REFERENCES \`photos\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`employee_info\` ADD CONSTRAINT \`FK_3978a0756ce89065075d6d1034e\` FOREIGN KEY (\`identityCardImage1Id\`) REFERENCES \`photos\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`updatedAt\` \`updatedAt\` datetime(0) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`photos\` CHANGE \`createdAt\` \`createdAt\` datetime(0) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`wards\` DROP COLUMN \`updatedAt\``);
        ...
        await queryRunner.query(`ALTER TABLE \`photos\` DROP COLUMN \`updatedAt\``);
    }
