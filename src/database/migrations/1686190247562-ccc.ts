...
export class Ccc1686190247562 implements MigrationInterface {
    name = 'Ccc1686190247562'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`name\` \`nameTest\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` DROP COLUMN \`nameTest\``);
        await queryRunner.query(`ALTER TABLE \`stations\` ADD \`nameTest\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`nameTest\` \`name\` varchar(255) NOT NULL`);
    }
