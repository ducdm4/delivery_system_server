...
export class UpdateUser21685358218192 implements MigrationInterface {
    name = 'UpdateUser21685358218192'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_f127c2c8d3618ee635c96c68c4\` ON \`users\``);
        await queryRunner.query(`DROP INDEX \`IDX_bafb08f60d7857f4670c172a6e\` ON \`users\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`districts\` ADD CONSTRAINT \`FK_65f489c5687887adeeb14b87df7\` FOREIGN KEY (\`cityId\`) REFERENCES \`cities\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_bafb08f60d7857f4670c172a6e\` ON \`users\` (\`addressId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_f127c2c8d3618ee635c96c68c4\` ON \`users\` (\`profilePictureId\`)`);
    }
