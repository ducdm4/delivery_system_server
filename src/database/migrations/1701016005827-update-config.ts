...
export class UpdateConfig1701016005827 implements MigrationInterface {
    name = 'UpdateConfig1701016005827'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`configs\` ADD \`value\` text NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`configs\` DROP COLUMN \`value\``);
        await queryRunner.query(`ALTER TABLE \`configs\` ADD \`value\` varchar(255) NOT NULL`);
