...
export class Change1684749981707 implements MigrationInterface {
    name = 'Change1684749981707'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`cities\` CHANGE \`engName\` \`slug\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`cities\` DROP COLUMN \`slug\``);
        await queryRunner.query(`ALTER TABLE \`cities\` ADD \`slug\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cities\` DROP COLUMN \`slug\``);
        await queryRunner.query(`ALTER TABLE \`cities\` ADD \`slug\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`cities\` CHANGE \`slug\` \`engName\` varchar(255) NOT NULL`);
    }
