...
export class UpdateStation21688618523774 implements MigrationInterface {
    name = 'UpdateStation21688618523774'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`photos\` ADD \`stationId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`photos\` DROP COLUMN \`stationId\``);
    }
