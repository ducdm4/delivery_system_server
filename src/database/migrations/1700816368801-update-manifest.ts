...
export class UpdateManifest1700816368801 implements MigrationInterface {
    name = 'UpdateManifest1700816368801'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`manifests_order_processed_orders\` (\`manifestsId\` int NOT NULL, \`ordersId\` int NOT NULL, INDEX \`IDX_e67f06c542cd17ed67cc1a151a\` (\`manifestsId\`), INDEX \`IDX_611ca49298669a43d45f6e135d\` (\`ordersId\`), PRIMARY KEY (\`manifestsId\`, \`ordersId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`manifests_order_processed_orders\` ADD CONSTRAINT \`FK_e67f06c542cd17ed67cc1a151a7\` FOREIGN KEY (\`manifestsId\`) REFERENCES \`manifests\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`manifests_order_processed_orders\` ADD CONSTRAINT \`FK_611ca49298669a43d45f6e135d7\` FOREIGN KEY (\`ordersId\`) REFERENCES \`orders\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`manifests_order_processed_orders\` DROP FOREIGN KEY \`FK_611ca49298669a43d45f6e135d7\``);
        await queryRunner.query(`ALTER TABLE \`manifests_order_processed_orders\` DROP FOREIGN KEY \`FK_e67f06c542cd17ed67cc1a151a7\``);
        await queryRunner.query(`ALTER TABLE \`routes\` DROP FOREIGN KEY \`FK_24cd15e58edc12ab45660c0ab10\``);
        await queryRunner.query(`ALTER TABLE \`routes\` DROP FOREIGN KEY \`FK_bc1a04791685505a291befd287d\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP FOREIGN KEY \`FK_695e77c7494649b393b54ada737\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP FOREIGN KEY \`FK_3ea424d49a50b261feecec5477f\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_611ca49298669a43d45f6e135d\` ON \`manifests_order_processed_orders\``);
        await queryRunner.query(`DROP INDEX \`IDX_e67f06c542cd17ed67cc1a151a\` ON \`manifests_order_processed_orders\``);
        await queryRunner.query(`DROP TABLE \`manifests_order_processed_orders\``);
    }
