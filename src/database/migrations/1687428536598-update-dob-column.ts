...
export class UpdateDobColumn1687428536598 implements MigrationInterface {
    name = 'UpdateDobColumn1687428536598'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`dob\` datetime NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`dob\``);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`dob\` varchar(255) NULL DEFAULT 'NULL'`);
