...
export class UpdateUser1685358006851 implements MigrationInterface {
    name = 'UpdateUser1685358006851'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user_info\` DROP COLUMN \`dob\``);
        await queryRunner.query(`ALTER TABLE \`user_info\` DROP COLUMN \`gender\``);
        await queryRunner.query(`ALTER TABLE \`user_info\` DROP COLUMN \`phone\``);
        await queryRunner.query(`ALTER TABLE \`user_info\` DROP COLUMN \`profilePictureId\``);
        await queryRunner.query(`ALTER TABLE \`user_info\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`user_info\` DROP COLUMN \`addressId\``);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`profilePictureId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD UNIQUE INDEX \`IDX_f127c2c8d3618ee635c96c68c4\` (\`profilePictureId\`)`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`addressId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD UNIQUE INDEX \`IDX_bafb08f60d7857f4670c172a6e\` (\`addressId\`)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_f127c2c8d3618ee635c96c68c4\` ON \`users\` (\`profilePictureId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_bafb08f60d7857f4670c172a6e\` ON \`users\` (\`addressId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP INDEX \`IDX_bafb08f60d7857f4670c172a6e\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`addressId\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP INDEX \`IDX_f127c2c8d3618ee635c96c68c4\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`profilePictureId\``);
        ...
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`addressId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`profilePictureId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`phone\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`gender\` tinyint NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`dob\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`lastName\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD \`firstName\` varchar(255) NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_917dca91af4d24821a88ab0bbd\` ON \`user_info\` (\`addressId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_3a7fa0c3809d19eaf2fb4f6594\` ON \`user_info\` (\`userId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_20aacdad0e3381adf77f6b8756\` ON \`user_info\` (\`profilePictureId\`)`);
