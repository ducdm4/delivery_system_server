...
export class UpdateStation1700929228368 implements MigrationInterface {
    name = 'UpdateStation1700929228368'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`stations_station_connected_stations\` (\`stationsId_1\` int NOT NULL, \`stationsId_2\` int NOT NULL, INDEX \`IDX_b4493b0152ab4dbd175d0e0829\` (\`stationsId_1\`), INDEX \`IDX_82632a5fa43148a9d3cd532fd9\` (\`stationsId_2\`), PRIMARY KEY (\`stationsId_1\`, \`stationsId_2\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`stationRoutine\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`stations_station_connected_stations\` ADD CONSTRAINT \`FK_b4493b0152ab4dbd175d0e08293\` FOREIGN KEY (\`stationsId_1\`) REFERENCES \`stations\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`stations_station_connected_stations\` ADD CONSTRAINT \`FK_82632a5fa43148a9d3cd532fd94\` FOREIGN KEY (\`stationsId_2\`) REFERENCES \`stations\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`stations_station_connected_stations\` DROP FOREIGN KEY \`FK_82632a5fa43148a9d3cd532fd94\``);
        await queryRunner.query(`ALTER TABLE \`stations_station_connected_stations\` DROP FOREIGN KEY \`FK_b4493b0152ab4dbd175d0e08293\``);
        await queryRunner.query(`ALTER TABLE \`routes\` DROP FOREIGN KEY \`FK_24cd15e58edc12ab45660c0ab10\``);
        await queryRunner.query(`ALTER TABLE \`routes\` DROP FOREIGN KEY \`FK_bc1a04791685505a291befd287d\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP FOREIGN KEY \`FK_695e77c7494649b393b54ada737\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP FOREIGN KEY \`FK_3ea424d49a50b261feecec5477f\``);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`stationRoutine\``);
        await queryRunner.query(`DROP INDEX \`IDX_82632a5fa43148a9d3cd532fd9\` ON \`stations_station_connected_stations\``);
        await queryRunner.query(`DROP INDEX \`IDX_b4493b0152ab4dbd175d0e0829\` ON \`stations_station_connected_stations\``);
        await queryRunner.query(`DROP TABLE \`stations_station_connected_stations\``);
    }
