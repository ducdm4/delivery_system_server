...
export class ChangePhotoTable1687337838659 implements MigrationInterface {
    name = 'ChangePhotoTable1687337838659'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`photos\` CHANGE \`url\` \`mimeType\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`photos\` DROP COLUMN \`mimeType\``);
        await queryRunner.query(`ALTER TABLE \`photos\` ADD \`mimeType\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`dob\` \`dob\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`dob\` \`dob\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`photos\` DROP COLUMN \`mimeType\``);
        await queryRunner.query(`ALTER TABLE \`photos\` ADD \`mimeType\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`photos\` CHANGE \`mimeType\` \`url\` varchar(255) NOT NULL`);
    }
