...
export class UpdateAddress1687857517460 implements MigrationInterface {
    name = 'UpdateAddress1687857517460'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`addresses\` CHANGE \`cityId\` \`cityId\` int NOT NULL DEFAULT '1'`);
    }
