...
export class UpdateAddressRelation1687863091256 implements MigrationInterface {
    name = 'UpdateAddressRelation1687863091256'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`ward\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`district\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`city\` int NULL DEFAULT 'NULL'`);
    }
