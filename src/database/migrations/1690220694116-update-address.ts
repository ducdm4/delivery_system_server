...
export class UpdateAddress1690220694116 implements MigrationInterface {
    name = 'UpdateAddress1690220694116'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`lat\` float NULL`);
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`lng\` float NULL`);
