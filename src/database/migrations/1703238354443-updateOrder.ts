...
export class UpdateOrder1703238354443 implements MigrationInterface {
    name = 'UpdateOrder1703238354443'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`cancelOTP\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`notificationToken\` \`notificationToken\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`notificationToken\` \`notificationToken\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`notificationToken\` \`notificationToken\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_1b65195fd4ef36e4c63f4169774\` FOREIGN KEY (\`dropOffAddressId\`) REFERENCES \`addresses\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_4eee1e5da3efd4038a2746bf50c\` FOREIGN KEY (\`pickupAddressId\`) REFERENCES \`addresses\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD CONSTRAINT \`FK_151b79a83ba240b0cb31b2302d1\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`notificationToken\` \`notificationToken\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`cancelOTP\``);
    }
