...
export class UpdateStation21688545729698 implements MigrationInterface {
    name = 'UpdateStation21688545729698'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`stations\` DROP COLUMN \`parentStation\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` ADD \`parentStation\` int NULL DEFAULT 'NULL'`);
    }
