...
export class UpdateOrderTracking1700815246452 implements MigrationInterface {
    name = 'UpdateOrderTracking1700815246452'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_695e77c7494649b393b54ada73\` ON \`order_tracking\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`proofNote\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`proofNote\``);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_695e77c7494649b393b54ada73\` ON \`order_tracking\` (\`proofId\`)`);
    }
