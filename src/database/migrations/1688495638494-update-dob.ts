...
export class UpdateDob1688495638494 implements MigrationInterface {
    name = 'UpdateDob1688495638494'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`dob\``);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`dob\` datetime NULL DEFAULT 'NULL'`);
