...
export class Create1689929213489 implements MigrationInterface {
    name = 'Create1689929213489'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`routes\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` int NOT NULL, \`isGoToParent\` tinyint NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`employeeId\` int NULL, \`stationId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`routes_streets_streets\` (\`routesId\` int NOT NULL, \`streetsId\` int NOT NULL, INDEX \`IDX_32a289f8b8668e120342244689\` (\`routesId\`), INDEX \`IDX_a6a8818c1c19d2ba742cd21c8f\` (\`streetsId\`), PRIMARY KEY (\`routesId\`, \`streetsId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`routes_child_station_stations\` (\`routesId\` int NOT NULL, \`stationsId\` int NOT NULL, INDEX \`IDX_f150470bd276779aff8b04a54b\` (\`routesId\`), INDEX \`IDX_eeee11bd1d5c981403de57ccbe\` (\`stationsId\`), PRIMARY KEY (\`routesId\`, \`stationsId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`routes_streets_streets\` ADD CONSTRAINT \`FK_32a289f8b8668e1203422446894\` FOREIGN KEY (\`routesId\`) REFERENCES \`routes\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`routes_streets_streets\` ADD CONSTRAINT \`FK_a6a8818c1c19d2ba742cd21c8f3\` FOREIGN KEY (\`streetsId\`) REFERENCES \`streets\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`routes_child_station_stations\` ADD CONSTRAINT \`FK_f150470bd276779aff8b04a54b8\` FOREIGN KEY (\`routesId\`) REFERENCES \`routes\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`routes_child_station_stations\` ADD CONSTRAINT \`FK_eeee11bd1d5c981403de57ccbef\` FOREIGN KEY (\`stationsId\`) REFERENCES \`stations\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`routes_child_station_stations\` DROP FOREIGN KEY \`FK_eeee11bd1d5c981403de57ccbef\``);
        await queryRunner.query(`ALTER TABLE \`routes_child_station_stations\` DROP FOREIGN KEY \`FK_f150470bd276779aff8b04a54b8\``);
        await queryRunner.query(`ALTER TABLE \`routes_streets_streets\` DROP FOREIGN KEY \`FK_a6a8818c1c19d2ba742cd21c8f3\``);
        await queryRunner.query(`ALTER TABLE \`routes_streets_streets\` DROP FOREIGN KEY \`FK_32a289f8b8668e1203422446894\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_eeee11bd1d5c981403de57ccbe\` ON \`routes_child_station_stations\``);
        await queryRunner.query(`DROP INDEX \`IDX_f150470bd276779aff8b04a54b\` ON \`routes_child_station_stations\``);
        await queryRunner.query(`DROP TABLE \`routes_child_station_stations\``);
        await queryRunner.query(`DROP INDEX \`IDX_a6a8818c1c19d2ba742cd21c8f\` ON \`routes_streets_streets\``);
        await queryRunner.query(`DROP INDEX \`IDX_32a289f8b8668e120342244689\` ON \`routes_streets_streets\``);
        await queryRunner.query(`DROP TABLE \`routes_streets_streets\``);
