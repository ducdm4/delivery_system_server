...
export class Change21684750053625 implements MigrationInterface {
    name = 'Change21684750053625'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`districts\` ADD \`slug\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`wards\` ADD \`slug\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`phone\` \`phone\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`profilePictureId\` \`profilePictureId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`userId\` \`userId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`addressId\` \`addressId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` DROP FOREIGN KEY \`FK_d077f78e3da856a69763bb467c0\``);
        await queryRunner.query(`ALTER TABLE \`districts\` DROP FOREIGN KEY \`FK_65f489c5687887adeeb14b87df7\``);
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`addressId\` \`addressId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`profilePictureId\` \`profilePictureId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` CHANGE \`phone\` \`phone\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD CONSTRAINT \`FK_917dca91af4d24821a88ab0bbdd\` FOREIGN KEY (\`addressId\`) REFERENCES \`addresses\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD CONSTRAINT \`FK_3a7fa0c3809d19eaf2fb4f65949\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user_info\` ADD CONSTRAINT \`FK_20aacdad0e3381adf77f6b8756c\` FOREIGN KEY (\`profilePictureId\`) REFERENCES \`photos\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`wards\` DROP COLUMN \`slug\``);
        await queryRunner.query(`ALTER TABLE \`districts\` DROP COLUMN \`slug\``);
    }
