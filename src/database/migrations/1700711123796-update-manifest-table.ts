...
export class UpdateManifestTable1700711123796 implements MigrationInterface {
    name = 'UpdateManifestTable1700711123796'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`manifests\` (\`id\` int NOT NULL AUTO_INCREMENT, \`isComplete\` tinyint NOT NULL, \`type\` int NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`employeeId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`manifests_orders_orders\` (\`manifestsId\` int NOT NULL, \`ordersId\` int NOT NULL, INDEX \`IDX_2b6d2b6098a4fa0857427508b2\` (\`manifestsId\`), INDEX \`IDX_5ff1a842165722eec6d4b9b0e5\` (\`ordersId\`), PRIMARY KEY (\`manifestsId\`, \`ordersId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`attempToPickup\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`proofId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD UNIQUE INDEX \`IDX_695e77c7494649b393b54ada73\` (\`proofId\`)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_695e77c7494649b393b54ada73\` ON \`order_tracking\` (\`proofId\`)`);
        ...
        await queryRunner.query(`ALTER TABLE \`manifests_orders_orders\` ADD CONSTRAINT \`FK_2b6d2b6098a4fa0857427508b21\` FOREIGN KEY (\`manifestsId\`) REFERENCES \`manifests\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`manifests_orders_orders\` ADD CONSTRAINT \`FK_5ff1a842165722eec6d4b9b0e5a\` FOREIGN KEY (\`ordersId\`) REFERENCES \`orders\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`manifests_orders_orders\` DROP FOREIGN KEY \`FK_5ff1a842165722eec6d4b9b0e5a\``);
        await queryRunner.query(`ALTER TABLE \`manifests_orders_orders\` DROP FOREIGN KEY \`FK_2b6d2b6098a4fa0857427508b21\``);
        await queryRunner.query(`ALTER TABLE \`routes\` DROP FOREIGN KEY \`FK_24cd15e58edc12ab45660c0ab10\``);
        await queryRunner.query(`ALTER TABLE \`routes\` DROP FOREIGN KEY \`FK_bc1a04791685505a291befd287d\``);
        ...
        await queryRunner.query(`ALTER TABLE \`photos\` DROP FOREIGN KEY \`FK_6a73ea111d7c2cafe69b8adf994\``);
        await queryRunner.query(`ALTER TABLE \`districts\` DROP FOREIGN KEY \`FK_65f489c5687887adeeb14b87df7\``);
        await queryRunner.query(`DROP INDEX \`REL_695e77c7494649b393b54ada73\` ON \`order_tracking\``);
        ...
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP INDEX \`IDX_695e77c7494649b393b54ada73\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`proofId\``);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`attempToPickup\``);
        await queryRunner.query(`DROP INDEX \`IDX_5ff1a842165722eec6d4b9b0e5\` ON \`manifests_orders_orders\``);
        await queryRunner.query(`DROP INDEX \`IDX_2b6d2b6098a4fa0857427508b2\` ON \`manifests_orders_orders\``);
        await queryRunner.query(`DROP TABLE \`manifests_orders_orders\``);
