...
export class UpdateOrder1689733170958 implements MigrationInterface {
    name = 'UpdateOrder1689733170958'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`senderEmail\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`receiverEmail\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`receiverEmail\``);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`senderEmail\``);
    }
