...
export class UpdateRoute1689873890856 implements MigrationInterface {
    name = 'UpdateRoute1689873890856'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_65f489c5687887adeeb14b87df7\` ON \`districts\``);
        await queryRunner.query(`DROP INDEX \`FK_6a73ea111d7c2cafe69b8adf994\` ON \`photos\``);
        await queryRunner.query(`DROP INDEX \`FK_c9547a97ccdd0f3c97d034d9547\` ON \`stations\``);
        await queryRunner.query(`DROP INDEX \`FK_812309cfc78b10b505a6cd44df5\` ON \`wards\``);
        await queryRunner.query(`DROP INDEX \`FK_a261a94099e10de936a887d835f\` ON \`wards\``);
        await queryRunner.query(`DROP INDEX \`FK_14231c98a880a83b63ae70ef3ed\` ON \`streets\``);
        await queryRunner.query(`DROP INDEX \`FK_221420cb636d4e9e48aeca528a0\` ON \`addresses\``);
        await queryRunner.query(`DROP INDEX \`FK_f975b3c53730463bc607d23bf8b\` ON \`addresses\``);
        await queryRunner.query(`DROP INDEX \`FK_606f0676c1ba471832c2fb97382\` ON \`addresses\``);
        await queryRunner.query(`DROP INDEX \`FK_304f5fd3d7cc18516194f8d2f3e\` ON \`addresses\``);
        await queryRunner.query(`DROP INDEX \`FK_3b4bef102967f512afe9f968db3\` ON \`employee_info\``);
        await queryRunner.query(`DROP INDEX \`FK_692a909ee0fa9383e7859f9b406\` ON \`notifications\``);
        await queryRunner.query(`DROP INDEX \`FK_151b79a83ba240b0cb31b2302d1\` ON \`orders\``);
        await queryRunner.query(`DROP INDEX \`FK_85acfbdf5c1c33daca863f8118b\` ON \`order_tracking\``);
        await queryRunner.query(`DROP INDEX \`FK_5d3b1dc47b00f72cd805bd2a284\` ON \`order_tracking\``);
        await queryRunner.query(`DROP INDEX \`FK_14ca841b5122aca4bbe9dea6f5f\` ON \`order_tracking\``);
        await queryRunner.query(`DROP INDEX \`FK_3ea424d49a50b261feecec5477f\` ON \`order_tracking\``);
        await queryRunner.query(`DROP INDEX \`FK_6ba773e1ec316866a17d46885a4\` ON \`parcels\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_6ba773e1ec316866a17d46885a4\` ON \`parcels\` (\`orderId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_3ea424d49a50b261feecec5477f\` ON \`order_tracking\` (\`shipperInChargeId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_14ca841b5122aca4bbe9dea6f5f\` ON \`order_tracking\` (\`collectorInChargeId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_5d3b1dc47b00f72cd805bd2a284\` ON \`order_tracking\` (\`stationInChargeId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_85acfbdf5c1c33daca863f8118b\` ON \`order_tracking\` (\`orderId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_151b79a83ba240b0cb31b2302d1\` ON \`orders\` (\`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_692a909ee0fa9383e7859f9b406\` ON \`notifications\` (\`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_3b4bef102967f512afe9f968db3\` ON \`employee_info\` (\`stationId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_304f5fd3d7cc18516194f8d2f3e\` ON \`addresses\` (\`streetId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_606f0676c1ba471832c2fb97382\` ON \`addresses\` (\`wardId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_f975b3c53730463bc607d23bf8b\` ON \`addresses\` (\`districtId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_221420cb636d4e9e48aeca528a0\` ON \`addresses\` (\`cityId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_14231c98a880a83b63ae70ef3ed\` ON \`streets\` (\`wardId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_a261a94099e10de936a887d835f\` ON \`wards\` (\`stationId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_812309cfc78b10b505a6cd44df5\` ON \`wards\` (\`districtId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_c9547a97ccdd0f3c97d034d9547\` ON \`stations\` (\`parentStationId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_6a73ea111d7c2cafe69b8adf994\` ON \`photos\` (\`stationId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_65f489c5687887adeeb14b87df7\` ON \`districts\` (\`cityId\`)`);
    }
