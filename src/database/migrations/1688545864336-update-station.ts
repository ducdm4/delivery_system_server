...
export class UpdateStation1688545864336 implements MigrationInterface {
    name = 'UpdateStation1688545864336'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`stations\` ADD \`parentStationId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` DROP COLUMN \`parentStationId\``);
    }
