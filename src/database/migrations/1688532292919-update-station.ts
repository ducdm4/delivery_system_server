...
export class UpdateStation1688532292919 implements MigrationInterface {
    name = 'UpdateStation1688532292919'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`stations\` DROP COLUMN \`wardList\``);
        await queryRunner.query(`ALTER TABLE \`wards\` ADD \`stationId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`type\` \`type\` int NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` CHANGE \`type\` \`type\` int NOT NULL DEFAULT '1'`);
        await queryRunner.query(`ALTER TABLE \`stations\` ADD CONSTRAINT \`FK_d077f78e3da856a69763bb467c0\` FOREIGN KEY (\`addressId\`) REFERENCES \`addresses\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`wards\` DROP COLUMN \`stationId\``);
        await queryRunner.query(`ALTER TABLE \`stations\` ADD \`wardList\` varchar(255) NULL DEFAULT 'NULL'`);
    }
