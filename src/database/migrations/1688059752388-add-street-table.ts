...
export class AddStreetTable1688059752388 implements MigrationInterface {
    name = 'AddStreetTable1688059752388'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`streets\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`slug\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`wardId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`detail\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`streetId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`addresses\` DROP COLUMN \`streetId\``);
        await queryRunner.query(`ALTER TABLE \`addresses\` DROP COLUMN \`detail\``);
        await queryRunner.query(`ALTER TABLE \`addresses\` ADD \`street\` varchar(255) NULL DEFAULT 'NULL'`);
