...
export class UpdateOrder1690196122498 implements MigrationInterface {
    name = 'UpdateOrder1690196122498'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`parcels\` CHANGE \`name\` \`description\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`cashOnDelivery\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`shippingFare\``);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`dropOffAddressId\``);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`cashOnDelivery\` \`cashOnDelivery\` float NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`shippingFare\` \`shippingFare\` float NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`numberOfAtTemp\` \`numberOfAtTemp\` int NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE \`parcels\` DROP COLUMN \`description\``);
        await queryRunner.query(`ALTER TABLE \`parcels\` ADD \`description\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`numberOfAtTemp\` \`numberOfAtTemp\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`shippingFare\` \`shippingFare\` float(12) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`dropOffAddressId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`shippingFare\` float(12) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`cashOnDelivery\` float(12) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`parcels\` CHANGE \`description\` \`name\` varchar(255) NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_bfb906fe040593decbb22794d8\` ON \`order_tracking\` (\`dropOffAddressId\`)`);
