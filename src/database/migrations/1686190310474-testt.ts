...
export class Testt1686190310474 implements MigrationInterface {
    name = 'Testt1686190310474'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`stations\` DROP COLUMN \`name\``);
        await queryRunner.query(`ALTER TABLE \`stations\` ADD \`name\` varchar(255) NOT NULL`);
