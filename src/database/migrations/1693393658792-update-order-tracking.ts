...
export class UpdateOrderTracking1693393658792 implements MigrationInterface {
    name = 'UpdateOrderTracking1693393658792'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`order_tracking\` DROP COLUMN \`isCancel\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_tracking\` ADD \`isCancel\` tinyint NOT NULL DEFAULT '0'`);
    }
